...
(defparameter *data-file* "~/cl/AOC/2023/day01/input.txt"
...
(defun Day01-pt1 (list-of-strings)
...
(5a:test Day01-pt1-test
  (5a:is (equal (Day01-pt1 *test-data*) 142)))
...
(defun Day01-pt2 (list-of-strings)
  (Day01-pt1 (mapcar #'replace-text-numbers-with-digits list-of-strings)))

(5a:test Day01-pt2-test
         (5a:is (equal (Day01-pt2 *test-data2*) 281)))

;; Now Solve the puzzle!
(time (format t "The answer to AOC 2023 Day 01 Part 1 is ~a"
              (Day01-pt1 (uiop:read-file-lines *data-file*))))

(time (format t "The answer to AOC 2023 Day 01 Part 2 is ~a"
              (Day01-pt2 (uiop:read-file-lines *data-file*))))
