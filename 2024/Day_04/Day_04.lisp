...
(defparameter *data-file* "~/cl/AOC/2024/Day_04/input.txt"
...
(5a:test Day_04-1-test
  (5a:is (= 18 (Day_04-1 *example*))))
...
(5a:test Day_04-2-test
  (5a:is (= 9 (Day_04-2 *example*))))

;; now solve the puzzle!
(time (format t "The answer to AOC 2024 Day 04 Part 1 is ~a"
              (day_04-1 (uiop:read-file-lines *data-file*))))

(time (format t "The answer to AOC 2024 Day 04 Part 2 is ~a"
              (day_04-2 (uiop:read-file-lines *data-file*))))
